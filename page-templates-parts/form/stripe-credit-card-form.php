<div class="form-row">
	<div class="creditCard">
		<div class="creditCard-row">
			...
			<input class="js-number-stripe js-check" type="hidden" data-stripe="number" min="1" max="9999999999999999" maxlength="16" data-validation="required">
		...
		<div class="creditCard-row creditCard-row--flex">
			...
			<div class="creditCard-expiration">
				...
				<div class="creditCard-expiration__select">
					<div class="creditCard-select js-open-list" data-list="month">
						...
						<input class="js-month-stripe js-check" type="hidden" maxlength="2" max="12" data-stripe="exp_month" data-validation="required">
					</div>

					<div class="creditCard-select js-open-list" data-list="year">
						<div class="creditCard-input js-year">Année</div> 
						<i class="fa fa-angle-down"></i>
						<input class="js-year-stripe js-check" type="hidden" maxlength="2" max="<?php echo $year+2; ?>" data-stripe="exp_year" data-validation="required">
					</div>
				</div>
			</div>
			...
			<div class="creditCard-security">
				...
				<input class="creditCard-input js-cvv js-input js-check" type="number" maxlength="3" max="999" data-stripe="number" data-validation="required">
			</div>
		</div>
