<div class="form-row">
	<div class="creditCard">		
		...
		<div class="creditCard-row">
			...
			<input class="js-number-stripe js-check" type="hidden" data-stripe="number" min="1" max="9999999999999999">
			<div class="creditCard-number">
				<input class="creditCard-input js-input js-card-number" type="number" data-length="4" max="9999" required>
				<input class="creditCard-input js-input js-card-number" type="number" data-length="4" max="9999" required>
				<input class="creditCard-input js-input js-card-number" type="number" data-length="4" max="9999" required>
				<input class="creditCard-input js-input js-card-number" type="number" data-length="4" max="9999" required>
			</div>
		...
		<div class="creditCard-row creditCard-row--flex">
			...
			<div class="creditCard-expiration">
				...
				<div class="creditCard-expiration__select">
					<div class="creditCard-select js-open-list" data-list="month">
						...
						<input class="js-month-stripe js-check" type="hidden" data-length="2" max="12" data-stripe="exp_month">
					</div>

					<div class="creditCard-select js-open-list" data-list="year">
						<div class="creditCard-input js-year">Année</div> 
						<i class="fa fa-angle-down"></i>
						<input class="js-year-stripe js-check" type="hidden" data-length="2" max="<?php echo $year+2; ?>" data-stripe="exp_year">
					</div>
				</div>
			</div>
			...
			<div class="creditCard-security">
				...
				<input class="creditCard-input js-cvv js-input js-check" type="number" data-length="3" max="999" data-stripe="cvc" required>
			</div>
		</div>
